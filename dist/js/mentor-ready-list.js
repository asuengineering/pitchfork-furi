/******/ (() => { // webpackBootstrap
/*!******************************************!*\
  !*** ./src/scripts/mentor-ready-list.js ***!
  \******************************************/
/**
...
function mentorReadyInit() {
  ...
  function applyFilters() {
    ...
    items.forEach(item => {
      ...
      const shouldShow = (programVal ? matchesProgram : true) && (projectVal ? matchesProject : true);
      if (shouldShow) {
    ...
    list.dispatchEvent(new CustomEvent('mentorFilters.changed', {
      detail: {
        program: programVal,
        project: projectVal,
...
/******/ })()
;
//# sourceMappingURL=mentor-ready-list.js.map