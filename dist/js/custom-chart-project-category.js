/******/ (() => { // webpackBootstrap
/*!******************************************************!*\
  !*** ./src/scripts/custom-chart-project-category.js ***!
  \******************************************************/
...
function drawBarChart() {
  var data = [['Research Topic', 'Project Count', {
    role: 'style'
  }, {
    role: 'annotation'
  }]];
  ...
  var chart = new google.visualization.ColumnChart(document.getElementById('subject-chart'));
  chart.draw(graphData, options);
}
/******/ })()
;
//# sourceMappingURL=custom-chart-project-category.js.map